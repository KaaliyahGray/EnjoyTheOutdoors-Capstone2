...
console.log(title);  }
 ...
 // Filter courses based on price selection
 function filterParks(LocationName) {
    const filteredParks = price === 'all' ? nationalParks : nationalParks.filter(LocationName => {
      if (LocationName === 'free') {
        return course.Price.toLowerCase() === 'free';
      } else if (price === 'under50') {
        return parseFloat(course.Price) < 50;
      } else if (price === 'under100') {
        return parseFloat(course.Price) < 100;
      } else {
        return parseFloat(course.Price) >= 100;
      }
    });
        ...
        <div class="col-md-4 mb-4">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="${course.CourseURL}" class="btn btn-primary">Learn More</a>
            <button class="myButton"> New Button</button>
